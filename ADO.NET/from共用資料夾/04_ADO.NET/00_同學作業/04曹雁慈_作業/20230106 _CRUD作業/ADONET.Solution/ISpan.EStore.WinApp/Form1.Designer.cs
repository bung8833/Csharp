namespace ISpan.EStore.WinApp
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.buttonMaintainNews = new System.Windows.Forms.Button();
			...
			// buttonMaintainUsers
			// 
			this.buttonMaintainUsers.Location = new System.Drawing.Point(416, 13);
			...
			// buttonMaintainNews
			// 
			this.buttonMaintainNews.Location = new System.Drawing.Point(416, 60);
			this.buttonMaintainNews.Name = "buttonMaintainNews";
			this.buttonMaintainNews.Size = new System.Drawing.Size(172, 23);
			this.buttonMaintainNews.TabIndex = 16;
			this.buttonMaintainNews.Text = "維護News資料";
			this.buttonMaintainNews.UseVisualStyleBackColor = true;
			this.buttonMaintainNews.Click += new System.EventHandler(this.buttonMaintainNews_Click);
			// 
			// buttonMaintainCategory
			// 
			this.buttonMaintainCategory.Location = new System.Drawing.Point(416, 104);
			this.buttonMaintainCategory.Name = "buttonMaintainCategory";
			this.buttonMaintainCategory.Size = new System.Drawing.Size(172, 23);
			this.buttonMaintainCategory.TabIndex = 17;
			this.buttonMaintainCategory.Text = "維護Category資料";
			this.buttonMaintainCategory.UseVisualStyleBackColor = true;
			this.buttonMaintainCategory.Click += new System.EventHandler(this.buttonMaintainCategory_Click);
			// 
			// buttonMaintainProduct
			// 
			this.buttonMaintainProduct.Location = new System.Drawing.Point(416, 146);
			this.buttonMaintainProduct.Name = "buttonMaintainProduct";
			this.buttonMaintainProduct.Size = new System.Drawing.Size(172, 23);
			this.buttonMaintainProduct.TabIndex = 18;
			this.buttonMaintainProduct.Text = "維護Product資料";
			...
			this.Controls.Add(this.buttonMaintainProduct);
			this.Controls.Add(this.buttonMaintainCategory);
			this.Controls.Add(this.buttonMaintainNews);
		...
		private System.Windows.Forms.Button buttonMaintainNews;
