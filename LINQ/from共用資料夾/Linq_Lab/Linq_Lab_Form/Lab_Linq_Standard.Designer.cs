...
{
	partial class Lab_Linq_Standard
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.dgvShow.Location = new System.Drawing.Point(162, 12);
			...
			this.button2.Text = "Linq Category";
			...
			this.Name = "Lab_Linq_Standard";
			this.Text = "Lab_Linq_Standard";
